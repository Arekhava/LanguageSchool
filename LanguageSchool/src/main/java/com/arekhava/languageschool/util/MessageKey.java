...
public class MessageKey {
	...
	public static final String INFO_SUBSCRIPTION_CANCELED_MESSAGE = "local.message.subscription_canceled";
	public static final String INFO_SUBSCRIPTION_PROCESSED_MESSAGE = "local.message.subscription_placed";
	public static final String INFO_LIKED_EMPTY_MESSAGE = "local.message.liked_empty";
	public static final String INFO_SUBSCRIPTIONS_PLACED_MESSAGE = "local.message.subscription_placed";
