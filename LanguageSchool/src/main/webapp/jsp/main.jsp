		...
		<div class="center">
			...
			<div class="languages">
				...
				<figure class="language">
					...
					<div class="image"><a href="${pageContext.request.contextPath}/controller?command=show_courses_from_language&languageId=${language.languageId}"  title="${language.languageName}"><img src="${pageContext.request.contextPath}/upload?imageName=${language.imageName}" alt="${language.languageName}"></a></div>
