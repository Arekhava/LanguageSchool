...
<%@ include file="/jsp/fragment/header.jsp" %>
	...
	<form class="add_course_form" action="${pageContext.request.contextPath}/upload" enctype="multipart/form-data" method="post">
		...
		<div>
			...
			<input type="text" name="courseName" required placeholder="${course_name}" maxlength="45"/>
		</div>
		<div>
			<label>${price}:</label>
