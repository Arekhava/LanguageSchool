...
<meta charset="utf-8">
  ...
  <fmt:message key="local.subscription_number" var="subscription_number"/>
...
<div class="wrapper">
	...
	<div class="main">
		...
		<form action="${pageContext.request.contextPath}/controller" method="get">
			...
			<input type="number" name="subscriptionId" required placeholder="№" min="1" max="9223372036854775807"/>
			<input type="submit" value="${search}"/>
		</form>
		<form action="${pageContext.request.contextPath}/controller" method="get">
		...
		<tr align="center" valign="center">
			...
			<td valign="center" align="center" >
				...
				<form class="cancel_subscription_form" action="${pageContext.request.contextPath}/controller" method="post">
					...
					<input type="hidden" name="subscriptionId" value="${subscription.subscriptionId}"/>
					<input type="hidden" name="status" value="${subscription.subscriptionStatus}"/>
					<c:if test="${sessionScope.role == 'STUDENT' && subscription.subscriptionStatus == 'ADDED_COURSE'}">
			...
			<td colspan="10">
				...
				<table class="courses_table" border="1px" bordercolor="c9c9c9">
					<thead bgcolor="#fff" align="center">
						<tr>
							<th><fmt:message key="local.course"/></th>
							<th>${price}</th>
							<th>${nextStart}</th>
						</tr>
					</thead>
					<c:forEach var="courses" items="${subscription.courses}">
					<tr align="center" valign="center">
